<template>
  <section v-if="items.length" class="exp-section timeline-section">
...
const title = computed(() => (props.section.config?.title as string) || 'Nossa história')
const items = computed(() => props.content.timeline)
</script>
