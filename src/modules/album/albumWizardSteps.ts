import { isMemoryBookPresentation, isMuralPresentation } from './book/presentations'
...
/** Murais (Polaroid / Retrato): sem editor de páginas. */
...
export function wizardStepsFor(presentation: string | null | undefined): AlbumWizardStep[] {
  if (isMuralPresentation(presentation)) {
