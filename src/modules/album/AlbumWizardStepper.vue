...
import {
  ALBUM_WIZARD_STEP_LABELS,
  ALBUM_WIZARD_STEPS,
  type AlbumWizardStep,
} from './albumWizardSteps'

const props = withDefaults(
  defineProps<{
    currentStep: AlbumWizardStep
    steps?: AlbumWizardStep[]
  }>(),
  { steps: () => ALBUM_WIZARD_STEPS },
)

defineEmits<{ go: [step: AlbumWizardStep] }>()
