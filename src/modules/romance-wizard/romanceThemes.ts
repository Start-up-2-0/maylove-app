...
export const ROMANCE_THEMES: RomanceThemeDefinition[] = [
  {
    ...
    accent: '#1db954',
    baseModelLabel: 'Experiência Player Musical',
  ...
  },
  {
    ...
    accent: '#c9a227',
    baseModelLabel: 'Experiência Cinema',
  ...
  },
  {
    ...
    accent: '#e11d48',
    baseModelLabel: 'Experiência Poesia Floral',
  ...
  },
  {
    ...
    accent: '#f97316',
    baseModelLabel: 'Experiência Retro Cassete',
    mediaRequirements: ['Música', 'Foto'],
    recommendedExperienceIds: ['declaracao-amor', 'pedido-namoro'],
  },
  {
    ...
    accent: '#db2777',
    baseModelLabel: 'Experiência Envelope Story',
  ...
  },
  {
    ...
    accent: '#be123c',
    baseModelLabel: 'Experiência Cortina de Amor',
  ...
  },
  {
    ...
    accent: '#64748b',
    baseModelLabel: 'Experiência Polaroid',
  ...
  },
  {
    ...
    accent: '#22c55e',
    baseModelLabel: 'Experiência Livro',
  ...
  },
  {
    ...
    accent: '#ec4899',
    baseModelLabel: 'Experiência Buquê',
  ...
  },
  {
    ...
    accent: '#f43f5e',
    baseModelLabel: 'Experiência Caixa de Presente',
  ...
  },
  {
    ...
    accent: '#ca8a04',
    baseModelLabel: 'Experiência Mapa do Tesouro',
    mediaRequirements: ['Capítulos', 'Fotos'],
    recommendedExperienceIds: ['nossa-historia'],
  },
  {
    ...
    accent: '#8b5cf6',
    baseModelLabel: 'Experiência Diário',
    mediaRequirements: ['Texto'],
  ...
  },
  {
    ...
    accent: '#818cf8',
    baseModelLabel: 'Experiência Conto Encantado',
    mediaRequirements: ['Foto', 'Texto'],
    recommendedExperienceIds: ['declaracao-amor', 'pedido-casamento'],
  },
  {
    ...
    accent: '#94a3b8',
    baseModelLabel: 'Experiência Retrospectiva',
    mediaRequirements: ['Capítulos', 'Fotos'],
    recommendedExperienceIds: ['nossa-historia'],
  },
  {
    ...
    accent: '#e50914',
    baseModelLabel: 'Experiência Nossa Série',
    mediaRequirements: ['Música', 'Foto'],
    recommendedExperienceIds: ['declaracao-amor', 'nossa-historia'],
  },
]
